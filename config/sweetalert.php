...
return [
    ...
    */
    ...
    'cdn' => env('SWEET_ALERT_CDN','https://unpkg.com/sweetalert/dist/sweetalert.min.js'),
    ...
    */
    ...
    'timer' => env('SWEET_ALERT_TIMER', 3500),//5000
    ...
    */
    ...
    'padding' => env('SWEET_ALERT_PADDING', '0.7rem'),//1.25rem
    ...
    */
    ...
    'toast_position' => env('SWEET_ALERT_TOAST_POSITION', 'top'),//top-end
    ...
    */
    ...
    'customClass' => [
        ...
        'container' => env('SWEET_ALERT_CONTAINER_CLASS','w-100'),
